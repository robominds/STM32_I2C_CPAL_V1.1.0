...
void Printf_Init(void)
{
  ...
  */
  ...
  printf("\r\n\n\n\r biotrump %s printf configured......", EVAL_COM1_STR);
  printf("\n\r ############ www.biotrump.com! ############ ("__DATE__ " - " __TIME__ ")");

  printf("%s", STM32F20x_STR);

  printf(" www.biotrump.com use __STM32F2XX_STDPERIPH_VERSION %d.%d.%d",
			__STM32F2XX_STDPERIPH_VERSION_MAIN,
			__STM32F2XX_STDPERIPH_VERSION_SUB1,
			__STM32F2XX_STDPERIPH_VERSION_SUB2);
  /*printf("\n\r 产品内部Flash大小为：%dK字节！ \t www.biotrump.com",
